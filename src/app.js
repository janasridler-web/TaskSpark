...
function openMoveTaskPicker(taskId) {
  ...
  list.innerHTML = targets.map(w => {
    ...
    return `<button class="btn-secondary" style="display:flex;align-items:center;gap:10px;text-align:left;padding:10px 14px;width:100%" onclick="moveTaskToWorkspace(${task.id},'${escJs(w.id)}')">
